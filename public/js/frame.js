...
<head>
   <script src="https://cdn.jsdelivr.net/gh/solual/-/ads/link.js"></script>
<title></title>
<style>
...
<a class="logo-link" href="https://${currentDomain}">
    <img src="https://${currentDomain}/assets/logo.webp" alt="Logo">
</a>
...
updateTabCloakPreview(tabCloak.value);
    ...
    a.href = downloadUrl;
    a.download = 'solo-central' + (path ? '_' + path.replace(/\//g, '_') : '') + '.html';
